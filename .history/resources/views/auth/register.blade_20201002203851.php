            ...
            <form method="POST" action="{{ route('register') }}">
                ...
                <div class="form-group row">
                        <div class="input-group mb-2">
                            ...
                            <input id="mobile" type="number" class="@error('mobile') is-invalid @enderror"
                                name="mobile"
                                value="{{ old('mobile') }}"
                                required
                                autofocus
                ...
                <div class="form-group row">
                        <select name="category" id="category" onchange="showOtherDropDown()" class="@error('category') is-invalid @enderror" required>
                ...
                <div class="form-group row d-none" id="gallery">
                        <select name="gallery" class="@error('gallery') is-invalid @enderror" id="galleryInput">
                ...
                <div class="form-group row d-none" id="special">
                        <select name="special" class="@error('special') is-invalid @enderror" id="specialInput">
                            <option value="" selected>-</option>
