                            ...
                            <div class="row row-cols-1">
                                ...
                                <div class="col py-5">
                                    ...
                                    <div class="container">
                                        <div id="countdown">
                                            <ul>
                                                <li><span id="days"></span>days</li> <p class="column">:</p>
                                                <li><span id="hours"></span>Hours</li> <p class="column">:</p>
                                                <li><span id="minutes"></span>Minutes</li> <p class="column">:</p>
                                                <li><span id="seconds"></span>Seconds</li>
                                            </ul>
                                            <h1 class="days"><span id="days"></h1> <p class="column">:</p>
                                            <h1 class="hours"></h1> <p  class="column">:</p>
                                            <h1 class="minutes"></h1> <p class="column">:</p>
                                            <h1 class="seconds"></h1>
                                            <h4 class="dayl">dd</h4>
